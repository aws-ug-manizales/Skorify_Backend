...
const match_1 = require("@skorify/domain/match");
const match_repository_1 = require("../src/repositories/match.repository");
async function testMatchRepository() {
    const repo = new match_repository_1.MatchRepository();
